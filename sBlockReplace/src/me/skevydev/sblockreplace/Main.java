package me.skevydev.sblockreplace;

import org.bukkit.Bukkit;
import org.bukkit.ChatColor;
import org.bukkit.plugin.java.JavaPlugin;

import eventos.EventBlock;

public class Main extends JavaPlugin {
	
	public void onEnable(){
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "Plugin sBlockRepalce Habilitado!");
	...
	public void onDisable(){
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "Plugin sBlockReplace Desabilitado!");
	...
	public void registrarEventos(){
		Bukkit.getPluginManager().registerEvents(new EventBlock(), this);
	}

package me.skevydev.shotbarsound;

import org.bukkit.Bukkit;
import org.bukkit.ChatColor;
import org.bukkit.plugin.java.JavaPlugin;

import eventos.EventHotbar;

public class Main extends JavaPlugin {
	
	public void onEnable(){
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "Plugin sHotbarSound Habilitado!");
	...
	public void onDisable(){
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "Plugin sHotbarSound Desabilitado!");
	...
	public void registrarEventos(){
		Bukkit.getPluginManager().registerEvents(new EventHotbar(), this);
	}

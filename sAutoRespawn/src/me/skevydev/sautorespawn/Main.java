package me.skevydev.sautorespawn;
...
public class Main extends JavaPlugin{
	...
	public void onEnable(){
		...
		Bukkit.getConsoleSender().sendMessage(ChatColor.GREEN + "Plugin sAutoRespawn Habilitado!");
	...
	public void onDisable(){
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage(ChatColor.RED + "Plugin sAutoRespawn Desabilitado!");
